...
export const exploreRails: Record<string, { title: string; links: SitemapLink[] }> = {
  ...
  '/monetary-policy': {
    ...
    links: [
      ...
      { label: 'Press releases', to: '/press', note: 'MPC-style announcements' },
  ...
  '/circulars': {
    ...
    links: [
      ...
      { label: 'Press releases', to: '/press', note: 'Public announcements' },
      { label: 'Search', to: '/search', note: 'Find by keyword' },
  ...
  '/press': {
    title: 'Explore next',
    links: [
      { label: 'News digests', to: '/news', note: 'Related card-style notes' },
  ...
  '/news': {
    title: 'Explore next',
    links: [
      { label: 'Press releases', to: '/press', note: 'Announcement-style list' },
      { label: 'Reports', to: '/reports', note: 'Deeper digests' },
      { label: 'Monetary policy', to: '/monetary-policy', note: 'Policy context' },
      { label: 'Circulars', to: '/circulars', note: 'Regulatory notes' },
    ],
  ...
  '/publications': {
    title: 'Explore next',
    links: [
      { label: 'Press releases', to: '/press', note: 'Press-desk chronology' },
  ...
  '/reports': {
    ...
    links: [
      ...
      { label: 'Data lab', to: '/data', note: 'Sample indicators' },
      { label: 'Monetary policy', to: '/monetary-policy', note: 'Policy framing' },
      { label: 'Press releases', to: '/press', note: 'Press-desk list' },
